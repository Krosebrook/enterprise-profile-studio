...
import { FileText, Edit, Trash2, Globe, Lock, Calendar, GripVertical } from 'lucide-react';
import { KnowledgeDocument, useMoveDocumentToFolder } from '@/hooks/useKnowledgeBase';
...
export function DraggableDocumentCard({ document, onDelete }: DraggableDocumentCardProps) {
